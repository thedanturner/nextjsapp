...
const Contacts = () => {
  return (
    <div className="flex-row grid-cols-2">
        ...
        <div
            ...
            <div className="relative z-10 mx-auto max-w-md">
                ...
                <div
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Leo duis ut diam quam nulla porttitor massa id.</p>
                </div>
